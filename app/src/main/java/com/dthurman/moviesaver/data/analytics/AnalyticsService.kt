 ...
 * feature usage, and other important events throughout the app.
 */
@Singleton
class AnalyticsService @Inject constructor() {
     ...
     * @param params Optional map of parameters to log with the event
     */
    ...
    // Predefined event constants for common actions
    object Events {
